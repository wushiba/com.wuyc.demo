...
//            UrlEncodedFormEntity formEntity = new UrlEncodedFormEntity(nameValuePairList, "utf-8");
            StringEntity stringEntity = new StringEntity(JSON.toJSONString(nameValuePairList), "utf-8");
//            formEntity.setContentType("application/json; charset=UTF-8");
     ...
     * @throws Exception
     */
    public static HttpResponse kdoPost(String host, String path, String method,
                                      Map<String, String> headers,
                                      Map<String, String> querys,
                                      String body)
            throws Exception {
