...
public class AdminMerchantManageController implements BaseController {
    ...
    public CommonResult<Void> updateMerchant(@Valid @NotNull(message = "编辑商户信息不能为空") UpdateMerchantReq req) {
        req.setOperatorId(getCurrentAdminUserId());
    ...
    public CommonResult<Void> disableMerchant(@NotNull(message = "商户ID不能为空") Integer merchantId) {
        ...
        return CommonResult.success(adminMerchantManageService.updateMerchantIsEnable(merchantId, getCurrentAdminUserId(), false));
    }
    ...
    public CommonResult<Void> enableMerchant(@NotNull(message = "商户ID不能为空") Integer merchantId) {
        ...
        return CommonResult.success(adminMerchantManageService.updateMerchantIsEnable(merchantId, getCurrentAdminUserId(), true));
    }
    ...
    @SaCheckLogin
    @SaCheckRole(value = {"sys"}, mode = SaMode.OR)
    public CommonResult<Void> loadGeoWebsite() {
