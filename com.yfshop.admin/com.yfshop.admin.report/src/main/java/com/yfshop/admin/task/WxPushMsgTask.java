...
public class WxPushMsgTask {
    ...
    @Async
    public void doTask(){
        WxPushTask wxPushTask= wxPushTaskMapper.selectOne(Wrappers.lambdaQuery(WxPushTask.class).ge(WxPushTask::getPushTime,LocalDateTime.now()).ge(WxPushTask::getStatus,"WAIT"));
        if (wxPushTask!=null){
